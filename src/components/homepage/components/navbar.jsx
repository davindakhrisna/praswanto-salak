        ...
        <nav class="flex items-center justify-between flex-wrap bg-white p-5">
            ...
            <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
                <div class="text-lg lg:flex-grow">
                    <a href="#responsive-header" class="block mt-4 lg:inline-block lg:mt-0 text-black font-medium hover:text-white mr-12">
                        Home
                    </a>
                    <a href="#responsive-header" class="block mt-4 lg:inline-block lg:mt-0 text-black font-medium hover:text-white mr-12">
                        About Us
                    ...
                    <a href="#responsive-header" class="block mt-4 lg:inline-block lg:mt-0 text-black font-medium hover:text-white">
                        Products
                    </a>
                </div>
