...
export default function NewsletterSection() {
  ...
  return (
    <div class="flex flex-col min-h-screen">
      <div class="relative w-full h-140 bg-cover bg-center" style={{"background-image": "url('https://images.unsplash.com/photo-1528092744838-b91de0a10615?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')"}}>
        <div class="absolute inset-0 bg- bg-opacity-40 flex flex-col justify-center items-center text-white text-center px-4">
          <h2 class="text-3xl font-bold">Get Our Latest Updates And Exclusive Promo By</h2>
    ...
    Join Now
      ...
      <footer class="bg-white py-8 px-10 flex flex-col md:flex-row justify-between text-gray-700">
        ...
        <div>
          ...
          <p class="mt-2 text-gray-500">Dukuh Wanasari, Desa Pucungwetan,<br />Kec. Sukoharjo, Kab Wonosobo</p>
        </div>
        <div>
      ...
      <div class="bg-white-100 text-right py-4 text-sm text-gray-500">
        <p class="mt-1"><a href="#" class="hover:underline">Privacy Policy</a> | <a href="#" class="hover:underline">Term Of Use</a></p>
      </div>
    </div>
  );
}
